...
function detectAlphabet(text) {
  // Check for Cyrillic characters (Uzbek Cyrillic specific)
  ...
  // Default to Latin if no Cyrillic detected
  return 'latin';
}
...
function simulateSearch(query) {
  // Detect alphabet automatically
  const detectedAlphabet = detectAlphabet(query);
  console.log(`Detected alphabet: ${detectedAlphabet}`);
