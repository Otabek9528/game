...
function renderBrowse(){
  ...
  document.getElementById("browseList").innerHTML=rows.length?rows.map(c=>card(c)).join(""):`<div class="empty"><div class="e">🚗</div><h3>Bu modelda e'lon yo'q</h3><p>Yuqoridagi nomdan boshqa modelni tanlang</p></div>`;
}
...
document.getElementById("brandSel").onclick=()=>{if(TAB==="browse")openPicker(sel=>setCurrent(sel));};
