...
const I18N = {
  ...
  translations: {
    ...
    'feature.housing': { uz: 'Uy-joy e\'lonlari', ru: 'Uy-joy e\'lonlari', en: 'Uy-joy e\'lonlari' },
...
'detail.menuInfoText':  { uz: "Menyungizni Muslim Vegukin orqali onlayn taqdim qilish va mijozlardan to'g'ridan-to'g'ri buyurtma qabul qilishni xohlasangiz, biz bilan bog'laning.",
    ...
    'qibla.phaseMove': { uz: 'Harakat', ru: 'Движение', en: 'Movement' },
    'qibla.phaseHold': { uz: 'Barqarorlik', ru: 'Стабильность', en: 'Stability' },
    'qibla.movements': { uz: 'harakat', ru: 'движений', en: 'movements' },
    'qibla.calibrateDescMove': { uz: 'Telefonni bilakni burab <strong>∞</strong> shaklida aylantiring — faqat surmang.', ru: 'Вращайте телефон в форме <strong>∞</strong>, поворачивая запястье — не просто перемещайте его.', en: 'Rotate your phone in an <strong>∞</strong> pattern by twisting your wrist — don\'t just slide it.' },
    'qibla.calibrateDescHold': { uz: 'Pufakchani markazda ushlab, qimirlamay turing.', ru: 'Держите пузырёк в центре и не двигайтесь.', en: 'Keep the bubble centered and hold still.' },
    'qibla.calibrateHoldStill': { uz: 'Endi telefonni tekis ushlab, qimirlatmang...', ru: 'Теперь держите телефон ровно и неподвижно...', en: 'Now hold your phone flat and still...' },
    'qibla.calibrateChecking': { uz: 'Barqarorlik tekshirilmoqda...', ru: 'Проверка стабильности...', en: 'Checking stability...' },
    'qibla.calibrateMoreMoves': { uz: 'Sensor hali tayyor emas — yana ∞ harakat qiling', ru: 'Сенсор ещё не готов — повторите движение ∞', en: 'Sensor not ready yet — repeat the ∞ motion' },
    'qibla.qualityCalibrate': { uz: 'Kalibratsiya kerak', ru: 'Нужна калибровка', en: 'Needs calibration' },
    'qibla.holdFlatShort': { uz: 'Telefonni tekis ushlang', ru: 'Держите телефон ровно', en: 'Hold your phone flat' },
