...
const I18N = {
  ...
  translations: {
    ...
    // ============================================
    // BARCODE — Scoped scan banner (M4)
    // ============================================
    'bc.store.scoped.scanningIn': { uz: 'Skanerlash:',          ru: 'Сканирование:',           en: 'Scanning:' },
 
    // ============================================
    // BARCODE — Result info banners (M4)
    // ============================================
    'bc.store.foundIn':       { uz: 'Topildi:',                                          ru: 'Найдено:',                                                en: 'Found in:' },
    'bc.store.notInThis':     { uz: 'Bu mahsulot',                                       ru: 'Этот товар не зарегистрирован в',                          en: 'This product is not registered for' },
    'bc.store.notInThisMid':  { uz: 'da emas, lekin',                                    ru: ', но есть в',                                              en: ', but it is in' },
    'bc.store.notInThisEnd':  { uz: 'da bor.',                                           ru: '.',                                                        en: '.' },
